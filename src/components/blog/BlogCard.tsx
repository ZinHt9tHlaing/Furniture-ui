...
const BlogCard = ({ posts }: BlogCardProps) => {
  return (
    <div className="my-8 grid grid-cols-1 gap-8 px-4 md:px-0 md:grid-cols-2 lg:px-0 lg:grid-cols-3">
      {posts.slice(0, 3).map((post) => (
        <div className="flex-col" key={post.id}>
          ...
          <h3 className="ml-4 line-clamp-1 font-bold text-lg">{post.title}</h3>
